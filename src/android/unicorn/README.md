...
1. 添加 SDK 到项目中。 
 - Android Studio: 在工程 build.gradle 文件中添加依赖即可。[![Download](https://api.bintray.com/packages/qiyukf/maven/qiyu-android-sdk/images/download.svg)](https://bintray.com/qiyukf/maven/qiyu-android-sdk/_latestVersion)
